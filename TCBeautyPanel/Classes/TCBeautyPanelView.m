...
#define SafeBottomHeight [UIApplication sharedApplication].statusBarFrame.size.height > 20 ? 34 : 0
...
- (void)commonInit
{
    ...
    TCMenuView *menu = [[TCMenuView alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.bounds) - MenuHeight - SafeBottomHeight,
    ...
    // Slider Setup
    self.slider.frame = CGRectMake(BeautyViewMargin * 4, CGRectGetMinY(menu.frame) - BeautyViewSliderHeight,
    ...
    self.sliderValueLabel.frame = CGRectMake(self.slider.frame.size.width + self.slider.frame.origin.x + BeautyViewMargin, self.slider.frame.origin.y, BeautyViewSliderHeight, BeautyViewSliderHeight);
...
- (void)layoutSubviews {
    ...
    _menu.frame = CGRectMake(0, CGRectGetHeight(self.bounds) - MenuHeight - _bottomOffset - SafeBottomHeight,
                             CGRectGetWidth(self.bounds), MenuHeight);
    self.slider.frame = CGRectMake(BeautyViewMargin * 4,
                                   CGRectGetMinY(_menu.frame) - BeautyViewSliderHeight,
...
didFinishDownloadingToURL:(NSURL *)location
{
    ...
    if ([SSZipArchive unzipFileAtPath:targetPath toDestination:pituDir]) {
